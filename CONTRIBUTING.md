...
1. [Pick/Create issue]() and assign yourself
   * If you are creating an issue, please be sure to answer the following questions. 
2. Clone the repository
   * Checkout this resource for cloning a repository to your local machine.
   
3. Create a new branch
   * Checkout this resource for creating and managing branches
   
4. Comment or push code once a month
   * If we don't hear from you or see any activity on the issue you assigned yourself after one month, we'll take you off of it to open the issue up for others.
   
5. Create a Pull Request
   * Before you create a pull request make sure you're passing the testing requirements outlined below!
   We also provide a Pull Request Template that you can find here. It should load in automatically when you create a pull request, but in case it doesn't feel free to copy and paste the one provided. Be sure to fill out everything on the pull request and make sure you can check off all the boxes!
   Checkout this resource for creating a Pull Request.
...
6. Respond to feedback
   * Once your pull request is out in the wild, one of our managing developers will respond with any feedback or changes that need to be applied in order to merge your pull request into main. 
   The feedback process may take a few rounds to get it right. Don't worry. We all go through that process, and the feedback helps us all grow as developers as well as ensure code quality in the library. 
   Checkout this resource about merging
